  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 py-10 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-lg border border-white/10 bg-white/[0.035] p-8 text-center">
        <p className="text-xs uppercase tracking-[0.24em] text-cyan-200">Profile not found</p>
        ...
        <Link
          href="/explore"
          className="mt-6 inline-flex items-center justify-center gap-2 bg-cyan-300 px-4 py-3 text-sm font-semibold text-black transition hover:bg-cyan-200"
        >
          <Search size={16} />
          Back to Explore
        </Link>
